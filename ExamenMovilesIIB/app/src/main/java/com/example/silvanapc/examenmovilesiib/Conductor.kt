...
class Conductor(var id: Int, var nombre: String, var apellido: String, var fechaNacimiento: String, var numeroAutos: Int,
                var licenciaValida: Int, var createdAt: Long,
